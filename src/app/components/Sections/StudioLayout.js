...
export default function StudioHeroSection() {
  return (
    <section className="bg-[#bf3a2b] text-white md:mt-[7rem] rounded-[50px] p-6 md:p-10 lg:p-16 w-full max-w-full xl:max-w-[90rem] 2xl:max-w-[96rem] mx-auto my-10 relative overflow-visible">
