  ...
  return (
    <div className="bg-pink-50 p-4 md:p-1 md:py-13 max-w-7xl mx-auto">
      ...
      <div className="flex justify-center md:justify-start">
        <button className="bg-red-600 hover:bg-red-700 hover:scale-105 transition-all duration-300 transform text-white px-3 py-1 md:px-4 md:py-2 rounded mb-4 md:mb-8">
